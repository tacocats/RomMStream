...
const EJS_PLATFORM_SLUGS = new Set([
  '3do', '3ds', 'acpc', 'amiga', 'amiga-cd32', 'arcade', 'atari-2600-plus',
  'atari-lynx-mkii', 'atari2600', 'atari5200', 'atari7800', 'c-plus-4', 'c128',
  'c64', 'colecovision', 'commmodore-128', 'commodore-64c', 'cpet', 'doom',
  'dos', 'famicom', 'fds', 'game-boy-adavance-sp', 'game-boy-light',
  'game-boy-micro', 'game-boy-pocket', 'game-televisison', 'gamegear', 'gb',
  'gba', 'gbc', 'genesis', 'intellivision', 'ique-player', 'jaguar', 'lynx',
  'master-system-girl', 'master-system-super-compact', 'mega-pc', 'n64', 'nds',
  'neo-geo-pocket', 'neo-geo-pocket-color', 'neogeoaes', 'neogeomvs', 'nes',
  'new-nintendo-3ds', 'new-style-nes', 'new-style-super-nes-model-sns-101',
  'nintendo-ds-lite', 'nintendo-dsi', 'nintendo-dsi-xl', 'pc-fx',
  'philips-cd-i', 'psp', 'psx', 'saturn', 'sega-game-box-9', 'sega-mark-iii',
  'sega-master-system-ii', 'sega-mega-drive-2-slash-genesis', 'sega-mega-jet',
  'sega-nomad', 'sega32', 'segacd', 'sfam', 'sms', 'snes',
  'super-famicom-jr-model-shvc-101', 'super-famicom-shvc-001',
  'super-nintendo-original-european-version', 'supergrafx', 'swancrystal',
  'tera-drive', 'tg16', 'turbografx-cd', 'vic-20', 'virtualboy', 'wonderswan',
  'wonderswan-color', 'zxs',
]);
